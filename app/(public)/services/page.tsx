...
import { SERVICES_DATA } from "@/lib/db";
import { ComicButton } from "@/components/comic/ComicButton";
import { StarburstBadge } from "@/components/comic/StarburstBadge";
import { Check, Flame, ArrowRight, Calculator, Sparkles } from "lucide-react";
        ...
        {SERVICES_DATA.map((service, index) => {
          ...
          return (
            <div
              ...
              style={{
                boxShadow: `8px 8px 0px ${service.palette.vibrant}`,
              }}
            >
              <div className={`grid grid-cols-1 lg:grid-cols-12 gap-10 items-center`}>
                ...
                <div className={`lg:col-span-5 ${isEven ? "lg:order-1" : "lg:order-2"}`}>
                  <div
                    ...
                    style={{ transform: `rotate(${service.palette.frameAngle || "-2deg"})` }}
                  >
                    <Image
                    ...
                    <div className="absolute top-3 right-3">
                      <span
                        ...
                        style={{
                          backgroundColor: service.palette.vibrant,
                          color: service.palette.contrastText,
                        }}
                      >
                        {service.badge}
                      </span>
                ...
                <div className={`lg:col-span-7 space-y-6 ${isEven ? "lg:order-2" : "lg:order-1"}`}>
                  ...
                  <div className="pt-4 border-t border-neutral-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="font-display text-2xl text-white">{service.startingPrice}</p>
                    </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="comic-card p-8 sm:p-12 bg-comic-black border-[3.5px] border-comic-yellow shadow-[10px_10px_0px_#FFE600] space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              ...
              <div className="p-4 bg-neutral-900 rounded border-2 border-comic-yellow text-center space-y-1">
